  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex flex-col">
        <span className="font-semibold text-green-700 tracking-tight leading-tight">Télémédecine</span>
        <span className="text-xs text-green-600 tracking-wide leading-tight">& E-Santé</span>
      </div>
    </div>
  );
}
